...
struct MessageItemView: View {
    @State var message: MessageItem = MessageItem(id: UUID(), messageContent: "Hello, how are you on this fine day, good sir? Wanted to reach out about the upcoming project.", messageSender: "Hamilton", messageReceiver: "Bugsy")
    var body: some View {
        VStack{
